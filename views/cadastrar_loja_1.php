...
<!--             <div class="control-group col-sm">
      ...
      <div class="row">
          ...
          <div class="form-group col-sm-3">
              <input type="checkbox" class="" name="delivery"  value="1" checked="">
...
<!--vai ser o titulo tambem no slug-->
    ...
    <div class="col-auto">
      <div class="form-check mb-2">
        <input class="form-check-input" type="checkbox" id="autoSizingCheck" name="ck[]" value="Sabádo">
        <label class="form-check-label" for="autoSizingCheck">
       Sabádo
        </label>
      </div>
    ...
    <div class="col-auto">
      <div class="form-check mb-2">
       ...
       Domingo
            ...
            <?php ($value['nome']=='Segunda')?'value="1" checked':''; ?>
      ...
      <div class="h5 mt-5">Seus contatos e canais de redes sociais </div>
        ...
        <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
                <label for="whatsapp">Whatsapp 2:</label>  <label class="text-danger">campo obrigatorio*</label>
