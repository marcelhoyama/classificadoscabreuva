...
<div class="container">
    ...
    <div class="text-center h3">Editar - Horário de Funcionamento</div>
    ...
    <form id="cadastrarfuncionamento" method="POST" enctype="multipart/form-data">
        ...
        <div class="control-group col-sm">
                  ...
                  <?php $funcionamentoLoja=$viewData['funcionamentoLoja'];?>
             ...
             <div class="row">
                ...
                <textarea name="horario_func" class="form-control"><?php echo $funcionamentoLoja['nome']?></textarea>
...
<!--                   <label for=""> Seu comercio/serviço</label> <label class="text-danger"></label></br>
                             
  
                   <input name="nome_fantasia" value='<?php// echo $funcionamentoLoja['nome_fantasia'];?>' >
    ...
    <div class="col-auto my-1">
      ...
      <select name="hora_domingo_inicio" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
        <option <?php ($funcionamentoLoja['hora_inicio']== $funcionamentoLoja['hora_inicio'])? 'selected':'';?> ><?php  
        
        $hora_inicio=$funcionamentoLoja['hora_inicio'];
        $hora_inicio= explode('9', $hora_inicio);
         $hora_inicio= implode('9:', $hora_inicio);
      ...
      <div class="col-auto my-1">
        ...
        <select name="hora_domingo_fim" class="custom-select mr-sm-2" id="inlineFormCustomSelect">
          <option <?php ($funcionamentoLoja['hora_fim']== $funcionamentoLoja['hora_fim'])? 'selected':'';?> ><?php  
        
        $hora_fim=$funcionamentoLoja['hora_fim'];
        $hora_fim= explode('21', $hora_fim);
         $hora_fim= implode('21:', $hora_fim);
    ...
    <div class="col-auto my-1">
      <div class="mr-sm-2">
        <input type="checkbox" class="" name="domingo"  value="7" <?php 
        ($funcionamentoLoja['id_dia_semana']== $funcionamentoLoja['id_dia_semana'])? 'checked=""':'';?> 
        >
