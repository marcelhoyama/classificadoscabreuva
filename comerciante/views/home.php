...
<div class="row" id="conteudo1">
  ...
  <div class="card-body">
    ...
    <p class="card-text text-dark">Você envia suas informações e veja nosso contrato.</p>
...
<div class="row" id="conteudo1" >
      ...
      <p class="text-white text-right">Vamos nos unir e ajudar uns aos outros, estamos criando essa plataforma simples, como um classficados virtual, em conjunto com os beneficios e parceiros local,com a Publicidade, propaganda e outros:</p>
...
<div class="row" id="conteudo2" >
    ...
    <!--    <div class="col">
        ...
        <h5 class="text-center text-muted">Vamos falar da sua segurança...</h5>
  ...
  <div class="form-group">
    ...
    <select class="form-control" id="assunto" name="assunto">
      <option>Canteiros de Obras</option>
      <option>Metalúrgicas</option>
      <option>Supermercados</option>
      <option>Escolas</option>
      <option>Clubes</option>
      <option>Condomínios</option>
      <option>Fiscais de Loja</option>
      <option>Escoltas</option>
